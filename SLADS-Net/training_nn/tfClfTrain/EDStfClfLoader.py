...
def tfClassify(x_test1):
    ...
    sess = tf.Session()
    new_saver = tf.train.import_meta_graph('/home/yzhang/Research-ANL/1_Projects/SLADS-Python-v4-EDS_ClfReg_20170407/training_nn/tfClfTrain/tfClfmodel.meta')
    new_saver.restore(sess, tf.train.latest_checkpoint('/home/yzhang/Research-ANL/1_Projects/SLADS-Python-v4-EDS_ClfReg_20170407/training_nn/tfClfTrain/./'))
